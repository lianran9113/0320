    ...
    if (storageTxt != null) {
        ...
        storageArr.forEach((shopinfo) => {
            str += '<div class="shop-item clearfix">' +
                ...
                '<span class="fl">' + shopinfo.nowprice + '元</span>' +
                '<p class="fl count" ' +
                'data-id="' + shopinfo.id + '" ' +
                'data-nowprice="' + shopinfo.nowprice + '" data-count="' + shopinfo.count + '"' +
                ...
                '<span class="updateCount" data-number="-1">-</span>' +
                '</p>' +
                '<em class="fl sumPrice">' + (shopinfo.count * shopinfo.nowprice) + '元</em>' +
        ...
        $(".updateCount").click(function () {
            ...
            storageArr.forEach((pro) => {
                if (pid == pro.id) {
                    ...
                    $(this).parent().next().html(pro.count * pro.nowprice + "元");
                    jiesuan();
                    return;
                }
            })
